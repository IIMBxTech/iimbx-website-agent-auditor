...
$job = Start-Job { python -m http.server 8765 --directory "c:\Users\harsh\OneDrive\Desktop\website audit experimenet with new brand comp" }

Write-Host "⏳ Waiting for server to be ready..." -ForegroundColor Yellow
Start-Sleep -Seconds 4

Write-Host "✅ Server ready. Launching grader..." -ForegroundColor Green
node "c:\Users\harsh\OneDrive\Desktop\website audit experimenet with new brand comp\run_grader.js"
